      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="flex-1 flex items-center justify-center px-6 py-12">
          <div className="max-w-3xl text-center">
            <div className="inline-block px-3 py-1 rounded-full bg-amber-500/10 text-amber-300 text-xs font-medium mb-6 border border-amber-500/20">
              AI · Voice · Memory
            </div>

            <h1 className="heading-shimmer text-4xl sm:text-6xl font-bold mb-5">
              Talk to the people you remember.
            </h1>

            <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
              MemoryTalk lets you create an AI companion that speaks, sounds, and
              feels like someone you know — using voice cloning and personality
              modeling.
            </p>
              ...
              {[
                {
                  icon: "🎙️",
                  title: "Voice cloning",
                  desc: "Upload a few audio samples and we'll clone the voice.",
                },
                {
                  icon: "🧠",
                  title: "Personality model",
                  desc: "Describe traits, mannerisms, and sample sentences to shape how they speak.",
                },
                {
                  icon: "💬",
                  title: "Real conversations",
                  desc: "Type or speak — get back text and audio replies in their voice.",
                },
              ].map((c) => (
                <div
                  key={c.title}
                  className="rounded-2xl p-5 backdrop-blur-sm border border-white/[0.07] bg-white/[0.03] hover:border-amber-500/20 hover:-translate-y-1 transition-all duration-300"
                >
                  <div className="text-2xl mb-2">{c.icon}</div>
                  <h3 className="font-semibold mb-1 text-amber-100/90">{c.title}</h3>
